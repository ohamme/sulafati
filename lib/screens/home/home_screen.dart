import 'package:sulafati/screens/salafiya/add_salafiya_screen.dart';
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              buildCard(context,Icons.groups,"السلفيات",Colors.green,() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const AddSalafiyaScreen(),
      ),
    );
  },
),
